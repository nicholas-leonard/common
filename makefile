test_threading: GeneralHashFunctions/GeneralHashFunctions.o test_threading.o threading.o database.o utils.o -lpthread -lpq -lpqtypes -lboost_serialization
	g++ -std=gnu++0x GeneralHashFunctions/GeneralHashFunctions.o  database.o utils.o threading.o test_threading.o \
	-o test_threading -lpthread -lpq -lpqtypes -lboost_serialization
